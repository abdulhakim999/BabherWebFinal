  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute inset-0 bg-[url('/images/نقش%20بني.png')] bg-cover bg-center bg-no-repeat opacity-5 dark:opacity-10 mix-blend-multiply dark:mix-blend-overlay"></div>
        <div className="absolute inset-0 bg-gradient-to-b from-white/80 via-white/50 to-white/80 dark:from-gray-900/80 dark:via-gray-900/50 dark:to-gray-900/80"></div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-8 max-w-5xl mx-auto">
          ...
          <ScrollReveal animation="fade-in">
            <div className="flex flex-col md:flex-row gap-8 mb-10 border-b border-gray-100 pb-8">
              <div className="w-32 h-32 md:w-40 md:h-40 rounded-full flex-shrink-0 mx-auto md:mx-0 overflow-hidden border-4 border-amber-100 shadow-lg">
                <img
                  src="/images/الشيخ.png"
                  alt="الشيخ محمد بن صالح بابحر"
